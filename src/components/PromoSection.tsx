...
export const PromoSection = () => {
    return (
        <section
            className="bg-red-500 grid grid-cols-2 gap-6 md:gap-20 lg:gap-40 relative h-44 md:h-80 md:pt-20 mt-20 md:mt-36 mb-8 md:mb-14">
            ...
            <div className={"col-start-2 pr-4 md:pr-12 overflow-hidden absolute -top-6 md:-top-12 bottom-0"}>
