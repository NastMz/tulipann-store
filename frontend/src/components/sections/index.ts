/**
 * Exports of section components from the components' module.
 *
 * @module components/sections
 * @exports {function} CategoryCard - CategoryCard component.
 * @exports {function} CategoryPreview - CategoryPreview component.
 * @exports {function} ChartBar - ChartBar component.
 * @exports {function} CommentaryCard - CommentaryCard component.
 * @exports {function} DiscoverCard - DiscoverCard component.
 * @exports {function} DiscoverSection - DiscoverSection component.
 * @exports {function} FilterBar - FilterBar component.
 * @exports {function} Hero - Hero component.
 * @exports {function} ProductCard - ProductCard component.
