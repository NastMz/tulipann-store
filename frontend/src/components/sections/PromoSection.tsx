...
export const PromoSection = () => {
    return (
        <section
            ...
            <div
                className={"flex flex-col gap-2 md:gap-4 px-6 md:px-12 pb-8 md:pb-20 items-start justify-end text-white px-2"}>
                <div>
                    <h2 className={"text-lg md:text-5xl font-bold"}>¡Terreno perfecto para ti!</h2>
                    <h2 className={"text-lg md:text-5xl font-bold"}>Construye tu sueño</h2>
                </div>
