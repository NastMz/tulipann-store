...
export const SearchBar = () => {
    ...
    const [searchItems, setSearchItems] = useState<(Product | Article)[]>([]);
    ...
    useEffect(() => {
        setSearchItems(search(searchInput));
    }, [searchInput]);
     ...
     * @returns {(Product | Article)[]} List of matching products and articles.
     */
                    ...
                    <div className={`${searchInput === '' ? 'hidden' : ''}`}>
                        {
                            searchItems.length > 0
                                            ...
                                            'rate' in item
                                                ...
                                                : <SearchArticleCard
                                                    item={{
                                                        ...
                                                        image: "banner" in item ? item.banner : {src: '', hash: ''},
                                ...
                                : <div
                                    className={"h-96 bg-slate-100 flex flex-col items-center justify-center text-center p-6 gap-1"}>
