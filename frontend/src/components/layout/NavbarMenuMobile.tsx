 ...
 * @property {Array<{ image: Image, to: string, title: string, subtitle: string }>} items - Array of objects representing the items to display in the menu.
                                    ...
                                    <div className={'h-full overflow-y-auto pb-12'}>
                                        ...
                                        {/*Login Menu*/}
                                        {
                                            store.getState().user.user.id !== ''
                                                ? <div onClick={() => toggleNavMenu()}><LoggedInMenu/></div>
                                                : <div onClick={() => toggleNavMenu()}><LoginOptions/></div>
                                        }
                                    </div>
                                </motion.div>
                            )
